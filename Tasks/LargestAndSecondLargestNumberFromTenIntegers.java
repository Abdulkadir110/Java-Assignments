...
//Create a condition if number is less than the largest thus the secondnumber is the //largest
...
import java.util.Scanner;
	...
	public class LargestAndSecondLargestNumberFromTenIntegers {
		...
		System.out.printf("The Second-largest number is: %d%n", secondsmallest);
