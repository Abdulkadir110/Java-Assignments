...
public class BackwardMenuMapOfNokia {
        ...
        switch (menuFunctionsChoice) {
            case 1:
                ...
                while ( phoneBookChoice == 0) {
                    System.out.println(menuFunctions);
                    System.out.print("Press a number: ");
                    menuFunctionsChoice = input.nextInt();
                    if (menuFunctionsChoice == 1) {
                        System.out.println("Phone book");
		 ...
		 while (settingsChoiceChoices == 0) {
                    System.out.println(menuFunctions);
                    System.out.print("Press a number: ");
                    settingsChoiceChoices = input.nextInt();
                    if ( settingsChoiceChoices == 0) {
